...
<div class="card card-grid">
    <x-table-toolbar title="Driver" placeholder="Cari nama / no HP…" addUrl="{{ route('admin.drivers.create') }}" addLabel="Tambah Driver" addTitle="Tambah Driver" filter="filter">
